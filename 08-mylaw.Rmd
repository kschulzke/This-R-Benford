...
MyLawPlot +   
  ...
  labs(title = "Bitcoin Trading Volumes 2018-2021", subtitle = "Actual vs Benford vs My Law Frequencies", y = "Relative frequency", x = "First two digits", caption = "Data source: Kaggle. Red = Benford's Law; Blue = 2018-2020 Actual, Green = 2021 Actual.")
```

## Plot diffs by pairs

Here, we plot *differences* between the actual and My Law frequencies. The "fill" color is implemented with `scale_fill_gradient`, with blue as the low end and red as the high.

```{r Plot MyLaw diffs, fig.align='center', message=FALSE, warning=FALSE}

MyLawDiffsPLot <- ggplot(MyLaw) + 
  ...
  labs(title = "Bitcoin Volume First-Digits Pairs Differences", subtitle = "2021 Actual vs My Law (2018-2020)", y = "Differences in relative frequency", x = "First two digits", caption = "Data source: Kaggle & Yahoo")
...
The apparent conformity to My Law justifies little concern over potential number manipulation, unless we assume that the data were deliberately fabricated to conform to My Law frequencies. There is little evidence to suggest any such fabrication.
