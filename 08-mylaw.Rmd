...
MyLawDiffsPLot <- ggplot(MyLaw) + 
  ...
  labs(title = "Bitcoin Volume First-Digits Pairs Differences", subtitle = "2021 compared to 2018-2020", y = "Differences in relative frequency", x = "First two digits", caption = "Data source: Kaggle")
