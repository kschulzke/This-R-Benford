...
Excel is especially problematic because of its popularity, [perceived infallibility](https://arxiv.org/abs/1801.10249), lack of data integrity safeguards, and lack of transparency (think hidden formulas). Despite all this, Excel is everywhere. For many, it's the go-to tool for data analysis. Yet, the ease with which Excel cell values and formulas can be altered and the relative invisibility of the alterations present enormous control risks.
