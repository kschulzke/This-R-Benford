...
I am typing these words into an [Rmarkdown](https://rmarkdown.rstudio.com/) (.Rmd) file that I view or "monitor" in R Studio. Each chapter of the book is contained in a separate .Rmd file. The chapters are collated and rendered in .html, .pdf and other formats as a book using a package called [bookdown](https://bookdown.org/). I use [Github](https://github.com/kschulzke/AICPA-Power-Play) for version control. I control these activities primarily through the R Studio IDE which, truth be told, has lots of GUI in it.

R and R Studio can be accessed through a free or low-cost account at [Posit.Cloud](https://posit.cloud/). Alternatively, they can be [locally installed on a laptop](https://rstudio-education.github.io/hopr/starting.html). Consistent with its open-source roots, R is operating-system agnostic; it works equally well on MacOS, Windows, and Linux. It's not currently feasible to use R Studio on a smartphone. Too much analytical power for such an "itty bitty living space"!
