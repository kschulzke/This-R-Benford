...
Notable departures from Benford's expectations can be, though not always are, a signal of data manipulation or simply artificial constraints that are part of the data generating process.

Visual assessment of the Benford's Law plots can highlight first-digit sequences for further sampling. However, in most audit situations, it would be impractical to apply tests of details to all observations that begin with a particular pair of digits. Aggregate statistical measures of Benford's Law conformity – like mean absolute deviation or "MAD" – are of limited practical utility but are nevertheless frequently quoted.
