...
Given a large enough "sample size" (referred to as "N"), Benford's Law can help in assessing the plausibility of a column of data. The word "sample" is, however, not quite accurate here because Benford's Law is typically applied to the entire set of numbers, not a sample thereof. The expected frequencies of all 90 first-two digit pairs are visualized in the bar chart below.
...
BfdPlot <- ggplot(BfdLawSub) +   
  geom_bar(aes(as.character.BfdLaw.bfd.digits., BfdLaw.bfd.benford.dist), stat = "identity", fill = "#0000CC", alpha = 0.5) + #https://www.rapidtables.com/web/color/RGB_Color.html
