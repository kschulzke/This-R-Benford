...
ggplot(BTC_line) +
  geom_line(aes(x = YrQtr, y = log10(Vol_Yah), color = "#404080", linewidth = .3, group = 1))+
  geom_line(aes(x = YrQtr, y = log10(Vol_BTC), color = "#69b3a2", linewidth = .3, group = 1))+
  theme_minimal()+
